...
const AccessibilityStatementFi: FunctionComponent = () => {
  return (
    <>
      ...
      <p>
        Tämä sivusto on julkaistu <time dateTime="2020-10-05">05.10.2020</time>{' '}
      ...
      <p>
        Tämä seloste on laadittu <time dateTime="2020-10-05">05.10.2020</time>{' '}
        ja päivitetty <time dateTime="2020-10-05">05.10.2020</time>
      </p>
